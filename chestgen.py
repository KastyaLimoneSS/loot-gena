...
Weapon = ["Боевой посох","Булава","Дубинка","Кинжал","Копье","Легкий молот","Метательное копье","Палица","Ручной топор","Серп","Арбалет, легкий","Дротик","Короткий лук","Праща",
          ...
          "Моргенштерн","Рапира","Пика","Секира","Скимитар","Трезубец","Цеп","Сеть","Длинный лук","Вилка","Вилы","Вилка","Вилка","Вилка","Вилка","Вилка"]
Dices = ["d2 ","d4 ","d6 ","d8 "]
...
class MyClient(discord.Client):
    ...
    async def on_message(self, message):
        ...
        if not has_role(message.author,812568275518226443):
            await message.channel.send('{0.author.nick}'.format(message) + command('{0.content}'.format(message)))
